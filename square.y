...
stmt: ID EQ NUM {
    ...
    | RETURN OPBRA IDFUNC ID OP NUM CLBRA {
    ...
    | RETURN OPBRA IDFUNC ID OP NUM CLBRA OP OPBRA IDFUNC ID OP NUM CLBRA {
      struct scope * rreturn = (struct scope *) malloc(sizeof(struct scope));
      (rreturn)->type = "return";
